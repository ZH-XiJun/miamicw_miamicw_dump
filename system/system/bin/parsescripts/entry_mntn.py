        ...
        for eacharea in list_area:
            ...
            if arearet == 2:
                ...
                for eachl2area in l2list_area:
                    ...
                    l2parse.entry_module(areabase.dirs, infile, version, mode, outfile, field_list)
                    l2areacnt = l2areacnt + 1;
                    print("entry parse l2area done.\n")
            elif arearet == 0:
                parsebase.entry_module(areabase.dirs, infile, version, mode, outfile, field_list)
